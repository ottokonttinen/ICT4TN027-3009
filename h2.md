...
10 Seuraavaksi kokeillaan syöttää itse koodia "Login_Count" ja "User_Id:" -kenttiin. Vinkit neuvovat kokeilemaan syötettä 0 tai 1=1. Komento hakee kaikki rivit taulusta "user_data", joissa "Login_Count" -kentän arvo on 0 ja "userid" -kentän arvo on 1 tai vertailu "1=1" on tosi. Koska "1=1" on aina tosi, tämä tarkoittaa käytännössä sitä, että kaikki rivit haetaan, joissa joko "Login_Count" on 0 tai "userid" on 1. 
```SQL
#10
