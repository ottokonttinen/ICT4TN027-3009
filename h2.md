...
Haetaan tietyn henkilön tiedot userid-parametrin perusteella. 
```SQL
#2 Try to retrieve the department of the employee Bob Franco.
SELECT department FROM employees WHERE userid = 96134
```

Vaihdetaan henkilön osasto. 
```SQL
#3 Try to change the department of Tobi Barnett to 'Sales'.
UPDATE employees SET department = 'Sales' WHERE userid = 89762
```

Lisätään taulukkoon uusi sarake nimeltään "phone".
```SQL
#4
ALTER TABLE employees ADD COLUMN phone VARCHAR(20)
```

Lisätään muokkausoikeudet käyttäjälle "UnauthorizedUser".
```SQL
#5
GRANT ALTER TABLE TO UnauthorizedUser
```

Tässä tehtävässä valitaan valmiit vaihehdoit valikosta. Tehtävässä annettujen vinkkien mukaan tarkoitus on saada haku, jonka kysely on aina tosi. 
![kuva](https://user-images.githubusercontent.com/103586741/233112005-33ea56d8-9e84-4d8a-896d-f847eb0507b4.png)
```SQL
#9
...
11. Ohjelmassa on kaksi hakukenttää, joiden avulla voidaan hakea tietyn työntekijän tiedot. Tehtävä on saada injektoitua koodi, jonka avulla taulukosta saadaan haettua kaikkien työntekijöiden tiedot.  
...
12. Tehtävässä injektoidaan uusia komentoja hakukenttään ketjumalla niitä edellisten perään. Tarkoituksena on injektoida komentoja, joka muuttaa henkilön palkaa taulukossa. Lopussa olevat 2 viivaa muuttavat komentojen jälkeisen koodin kommentiksi.  
Employee Name:`' OR '1' = '1`  
...
![kuva](https://user-images.githubusercontent.com/103586741/232078608-94188261-080e-48c7-9b74-9671acf00662.png)
   ...
   + Password Reset  
   Tässä tehtävässä on esimerkki heikosta turvakysymyksestä, jonka avulla palauttaa käyttäjän salasanan pelkästään arvaamalla vastauksen kysymykseen. 
   ![kuva](https://user-images.githubusercontent.com/103586741/232105152-5244ec14-8639-4a91-a021-da2f20868545.png)
...
En saanut viimeisiä tehtäviä tehtyä, koska asentamassani WebGoatissa ei toiminut tehtävissä vaadittu erillinen WebWolf.
![kuva](https://user-images.githubusercontent.com/103586741/232334317-c20ce2d1-f71a-49dc-acca-b4d8caed5b22.png)
