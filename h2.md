...
+ A7 Cross Site Scripting (XSS): Cross site scripting
    + 2 What is XSS?  
    Vertailin evästettä kahdelta avoimelta selaimen välilehdeltä, jotka osoittivat molemmat samalla sivulle. yötin selaimen konsoliin komennon `javascript:alert(document.cookie)`, mikä antoi pop-ikkunan. Evästeet olivat identtisiä.
