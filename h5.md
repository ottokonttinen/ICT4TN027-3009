...
```
Valitsen NTLM-tiivisteen numeron 1000 Hashcat-ohjelmaan ja yritän murtaa tiivisteen käyttäen sanakirjaa. Viimeinen parametri tallentaa salananen erilliseen tiedostoon.
`hashcat -m 1000 tiiviste sanakirja.txt -o salasana`
