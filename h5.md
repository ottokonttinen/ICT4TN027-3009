...
Hashcat on lähdekoodin salasanojen murtamiseen tarkoitettu ohjelma. Hash on salasanan tiiviste, jollaisena ne tallennetaan tietokoinelle. Tiivistefunktion tulokset ovat yksisuuntaisia, eli niitä ei voi muuttaa takaisin salasanoiksi, mutta tietokone voi yrittää kokeilla vastaavatko tietyt sanat tiivisteitä. Ohjelman täytyy ensiksi tietää minkä tyyppinen tiiviste on kyseessä komennolla 'hashid'.

Komento salasanan murtamiseksi voi näyttää esimerksiksi tältä: `hashcat -m 0 '6b1628b016dff46e6fa35684be6acc96' rockyou.txt -o solved`. Parametri määrittää "-m 0" hash-tyypin. Sen jälkeen tulee itse hash pitkänä merkkijonona ja käytetty sanakirja, joka sisältää yleisiä salasanoja. Viimeinen parametri tallentaa löydetyn salasanan tiedostoon nimeltä "solved". Ohjelma siis yrittää murtaa annetun hashin käyttäen rockyou.txt-sanakirjaa.
